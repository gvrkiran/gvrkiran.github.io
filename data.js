...
const TEACHING = [
  {course: "Understanding, Designing, and Building Social Media", term: "Spring 2026", info: "PhD-level course that studies social media as both a technology and a social system. We will look at what social media is, why it has been so successful over the past two decades, and what design choices helped it grow and shape society. A key part of the course is thinking about what social media could become in a world where AI is everywhere, including how AI may change creation, sharing, moderation, discovery, and trust online. For the full syllabus, please visit <a href='https://kiran-research2.comminfo.rutgers.edu/designing-social-media-course' target='_blank'>here</a>."},
  {course: "Beyond the Hype: What AI Can and Cannot Do", term: "Summer 2025/26", info: "Graduate course exploring capabilities and limits of modern AI. Based on the AI Snake Oil book by Sayash Kapoor and Arvind Narayanan and a bunch of other recent readings. Check out a <a href='https://www.youtube.com/watch?v=RqjsbuhgXqo&list=PLvK4dRPIjeyGh2mCM6-SE2jGefnOcr83s' target='_blank' style='color:blue'>YouTube playlist</a> I created about how I use AI in my daily life."},
