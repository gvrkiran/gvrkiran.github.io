...
const TEACHING = [
  {course: "Understanding, Designing, and Building Social Media", term: "Spring 2026", info: "is a PhD-level course that studies social media as both a technology and a social system. We will look at what social media is, why it has been so successful over the past two decades, and what design choices helped it grow and shape society. A key part of the course is thinking about what social media could become in a world where AI is everywhere, including how AI may change creation, sharing, moderation, discovery, and trust online. The course mixes reading, discussion, and hands-on work. Students will analyze real platforms and also propose and prototype new ideas for social media systems that fit today’s needs and future challenges. Topics I cover include platform design, network effects, incentives, communities, content ranking, safety and governance, misinformation, privacy, and the changing role of identity and authenticity. For the full syllabus, please reach out to me. I will try to record and release some of the videos from the class."},
